...
//const API=axios.create({baseURL:`https://your-tube-diss.onrender.com`})
...
export const addtodownload=(downloadvideo)=>API.post('/video/download',downloadvideo)
export const getalldownload=()=>API.get('/video/getalldownload')
export const deletedownload=(videoid,viewer)=>API.delete(`/video/deletedownload/${videoid}/${viewer}`)

    ...
    <div className="container_DrawaerLeftSidebar" style={toggledrawersidebar}>
      <div className="container2_DrawaerLeftSidebar">
        ...
        <div className="libraryBtn_Drawerleftsidebar">
          ...
          <NavLink className="icon_sidebar_div" to={'/Download'}>
            <p>
              <MdDownload size={22} className="icon_sidebar" style={{margin:"auto 0.7rem"}}/>
              <div className="text_sidebar_icon">Download</div>
            </p>
          </NavLink>
          <NavLink className="icon_sidebar_div" to={'/Videocall'}>
            <p>
              <div className="text_sidebar_icon">Go live with your friends</div>
            </p>
          </NavLink>
        </div>
